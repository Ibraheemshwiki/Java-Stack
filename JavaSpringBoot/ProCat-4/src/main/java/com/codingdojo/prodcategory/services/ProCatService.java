...
public class ProCatService {
	...
	public Category addCategoryProduct(Long pid,Long cid) {
		Product thisProduct = getProduct(pid);
		Category thisCategory = getCategory(cid);
		
		List<Product> newList = thisCategory.getProducts();
		
		newList.add(thisProduct);
		thisCategory.setProducts(newList);
